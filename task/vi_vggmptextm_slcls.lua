...
function task:defineModel(  )
	...
	if diffLevel == 0 then
		...
		diff:add( nn.View( -1, 3, inputSize, inputSize ) )
		diff:cuda(  )
	...
	elseif diffLevel == 2 then
		local diff = nn.Sequential(  )
		diff:add( nn.View( -1, seqLength, 256 * 26 * 26 ) )
		diff:add( nn.ConcatTable(  ):add( nn.Narrow( 2, 1 + diffScale, seqLength2 ) ):add( nn.Narrow( 2, 1, seqLength2 ) ) )
		diff:add( nn.CSubTable(  ) )
		diff:add( nn.View( -1, 256, 26, 26 ) )
		diff:cuda(  )
		model.modules[ 1 ]:insert( diff, 7 )
	elseif diffLevel == 3 then
		local diff = nn.Sequential(  )
		diff:add( nn.View( -1, seqLength, 512 * 13 * 13 ) )
		diff:add( nn.ConcatTable(  ):add( nn.Narrow( 2, 1 + diffScale, seqLength2 ) ):add( nn.Narrow( 2, 1, seqLength2 ) ) )
		diff:add( nn.CSubTable(  ) )
		diff:add( nn.View( -1, 512, 13, 13 ) )
		diff:cuda(  )
	...
	elseif diffLevel == 6 then
		local diff = nn.Sequential(  )
		diff:add( nn.View( -1, seqLength, 4096 ) )
		diff:add( nn.ConcatTable(  ):add( nn.Narrow( 2, 1 + diffScale, seqLength2 ) ):add( nn.Narrow( 2, 1, seqLength2 ) ) )
		diff:add( nn.CSubTable(  ) )
		diff:add( nn.View( -1, 4096 ) )
		diff:cuda(  )
		model.modules[ 1 ]:insert( diff, 19 )
	elseif diffLevel == 7 then
		local diff = nn.Sequential(  )
		diff:add( nn.View( -1, seqLength, featSize ) )
		diff:add( nn.ConcatTable(  ):add( nn.Narrow( 2, 1 + diffScale, seqLength2 ) ):add( nn.Narrow( 2, 1, seqLength2 ) ) )
		diff:add( nn.CSubTable(  ) )
		diff:add( nn.View( -1, featSize ) )
		diff:cuda(  )
