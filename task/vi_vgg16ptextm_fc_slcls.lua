...
function task:getModel(  )
	...
	print( model )
	print(criterion)
	self:print( 'Transfer params to GPU.' )
...
function task:parseOption( arg )
	...
	cmd:option( '-epochSize', 1192, 'Number of batches per epoch. (numVideo*seqLength/batchSize)' )
...
function task:defineModel(  )
	...
	elseif sumLevel == 1 then
		local sum = nn.Sequential(  )
		sum:add( nn.Reshape( numVideo, seqLength2, 64 * 224 * 224 ) )
		sum:add( nn.Mean( 2 ) )
		sum:add( nn.Reshape( numVideo, 64, 224, 224 ) )
		sum:cuda(  )
		model.modules[ 1 ]:insert( sum, 5 )
	elseif sumLevel == 2 then
		local sum = nn.Sequential(  )
		sum:add( nn.Reshape( numVideo, seqLength2, 128 * 112 * 112 ) )
		sum:add( nn.Mean( 2 ) )
		sum:add( nn.Reshape( numVideo, 128, 112, 112 ) )
		sum:cuda(  )
		model.modules[ 1 ]:insert( sum, 10 )
	elseif sumLevel == 3 then
		local sum = nn.Sequential(  )
		sum:add( nn.Reshape( numVideo, seqLength2, 256 * 56 * 56 ) )
		sum:add( nn.Mean( 2 ) )
		sum:add( nn.Reshape( numVideo, 256, 56, 56 ) )
		sum:cuda(  )
		model.modules[ 1 ]:insert( sum, 17 )
	elseif sumLevel == 4 then
		local sum = nn.Sequential(  )
		sum:add( nn.Reshape( numVideo, seqLength2, 512 * 28 * 28 ) )
		sum:add( nn.Mean( 2 ) )
		sum:add( nn.Reshape( numVideo, 512, 28, 28 ) )
		sum:cuda(  )
		model.modules[ 1 ]:insert( sum, 24 )
	elseif sumLevel == 5 then
		local sum = nn.Sequential(  )
		sum:add( nn.Reshape( numVideo, seqLength2, 512 * 14 * 14 ) )
		sum:add( nn.Mean( 2 ) )
		sum:add( nn.Reshape( numVideo, 512, 14, 14 ) )
		sum:cuda(  )
		model.modules[ 1 ]:insert( sum, 31 )
	...
	elseif diffLevel == 1 then
		local diff = nn.Sequential(  )
		diff:add( nn.Reshape( numVideo, seqLength, 64 * 224 * 224 ) )
		diff:add( nn.ConcatTable(  ):add( nn.Narrow( 2, 1 + diffScale, seqLength2 ) ):add( nn.Narrow( 2, 1, seqLength2 ) ) )
		diff:add( nn.CSubTable(  ) )
		diff:add( nn.Reshape( numVideo * seqLength2, 64, 224, 224 ) )
		diff:cuda(  )
		model.modules[ 1 ]:insert( diff, 5 )
	elseif diffLevel == 2 then
		local diff = nn.Sequential(  )
		diff:add( nn.Reshape( numVideo, seqLength, 128 * 112 * 112 ) )
		diff:add( nn.ConcatTable(  ):add( nn.Narrow( 2, 1 + diffScale, seqLength2 ) ):add( nn.Narrow( 2, 1, seqLength2 ) ) )
		diff:add( nn.CSubTable(  ) )
		diff:add( nn.Reshape( numVideo * seqLength2, 128, 112, 112 ) )
		diff:cuda(  )
		model.modules[ 1 ]:insert( diff, 10 )
	elseif diffLevel == 3 then
		local diff = nn.Sequential(  )
		diff:add( nn.Reshape( numVideo, seqLength, 256 * 56 * 56 ) )
		diff:add( nn.ConcatTable(  ):add( nn.Narrow( 2, 1 + diffScale, seqLength2 ) ):add( nn.Narrow( 2, 1, seqLength2 ) ) )
		diff:add( nn.CSubTable(  ) )
		diff:add( nn.Reshape( numVideo * seqLength2, 256, 56, 56 ) )
		diff:cuda(  )
		model.modules[ 1 ]:insert( diff, 17 )
	elseif diffLevel == 4 then
		local diff = nn.Sequential(  )
		diff:add( nn.Reshape( numVideo, seqLength, 512 * 28 * 28 ) )
		diff:add( nn.ConcatTable(  ):add( nn.Narrow( 2, 1 + diffScale, seqLength2 ) ):add( nn.Narrow( 2, 1, seqLength2 ) ) )
		diff:add( nn.CSubTable(  ) )
		diff:add( nn.Reshape( numVideo * seqLength2, 512, 28, 28 ) )
		diff:cuda(  )
		model.modules[ 1 ]:insert( diff, 24 )
	elseif diffLevel == 5 then
		local diff = nn.Sequential(  )
		diff:add( nn.Reshape( numVideo, seqLength, 512 * 14 * 14 ) )
		diff:add( nn.ConcatTable(  ):add( nn.Narrow( 2, 1 + diffScale, seqLength2 ) ):add( nn.Narrow( 2, 1, seqLength2 ) ) )
		diff:add( nn.CSubTable(  ) )
		diff:add( nn.Reshape( numVideo * seqLength2, 512, 14, 14 ) )
		diff:cuda(  )
		model.modules[ 1 ]:insert( diff, 31 )
	elseif diffLevel == 6 then
		...
		diff:cuda(  )
		model.modules[ 1 ]:insert( diff, 35 )
